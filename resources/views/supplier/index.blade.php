...
<div class="card-header border-0 pt-5">
    <h2 class="card-title align-items-start flex-column">
		...
		<span class="text-muted mt-1 fw-bold fs-7">Supplier List</span>
    </h2>
    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a supplier">
		<a href="{{ route('supplier.add') }}" class="btn btn-sm btn-light-primary" data-bs-target="#kt_modal_invite_friends">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bolder text-hover-primary fs-6">{{$supplier->company_name}}</p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bolder text-hover-primary fs-6">{{$supplier->phone_number}}</p>
                                </div>
                            </div>
                        </td>
                        <td class="text-end">
                            <a href="/supplier/edit/{{$supplier->supplier_id}}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                            ...
                            <a href="/supplier/delete/{{$supplier->supplier_id}}" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm me-1">
