...
<div class="card-header border-0 pt-5">
    <h2 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">Inventory</span>
		<span class="text-muted mt-1 fw-bold fs-7">Products</span>
    </h2>
    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a product">
		<a href="{{ route('product.add') }}" class="btn btn-sm btn-light-primary" data-bs-target="#kt_modal_invite_friends">
            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                <thead>
                    <tr class="fw-bolder text-muted">
                        ...
                        <th class="min-w-150px">Stock Quantity</th>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bolder text-hover-primary fs-6">{{$product->name}}</p>
                                </div>
                            </div>
                        </td>
                        <td @if ($product->stock_qty <= $product->critical_qty) class="bg-danger" @endif>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bolder text-hover-primary fs-6">{{$product->stock_qty}}</p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <p class="text-dark fw-bolder text-hover-primary fs-6">{{$product->price}}</p>
                                </div>
                            </div>
                        </td>
                        <td class="text-end">
                            <a href="/product/view/{{$product->product_id}}" class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                            ...
                            <a href="/product/edit/{{$product->product_id}}" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1">
                            ...
                            <a href="/product/delete/{{$product->product_id}}" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
