...
<div class="container-fluid">
    <div class="pull-right">
        ...
        <a class="btn btn-primary" href="{{route('sale.monthly')}}" style="margin-left: 210px;">Monthly Sales</a>
    </div><br>

    <div class="card-header border-0 pt-5">
        <h2 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Today's Sales</span><br>
